    ...
    <section class="dashboard-container">
        <article class="container-left">
            ...
            if(isset($_GET['bookid'])){
                if(checkImageExist() != '' ){
                    ...
                    ?>
            <form class="complaint" action="complain.php" method="post" enctype="multipart/form-data">
                <h3 class="booking-title">Aduan</h3>
                ...
                if(isset($_GET["bookid"])){
                    ...
                    <div class="form-group">
                        <label for="complain">Deskripsi Aduan</label>
                        <textarea name="complain" id="complain" cols="30" rows="10" class="form-control"></textarea>    
                    </div>  
                    <div class="form-group "> 
                        <label for="image">Gambar Sebelum</label>
                        <input type="file" name="before-image" id="image" class="form-control">
                    </div>
                    <div class="form-group "> 
                        <label for="image">Gambar Selepas</label>
                        <input type="file" name="after-image" id="image" class="form-control">
                    </div>
                    <div class="form-group "> 
                        <input hidden name="booking_id" type="text" value= <?=$_GET['bookid'];?>>
                    </div>
        ...
        <article class="container-right">
            ...
            <?php
                ...
                $sqlBooking= "select a.*, time as book_time, court_name, complaint_before, complaint_after from booking a NATURAL join time natural join court left join complaint b  on b.booking_id = a.booking_id where user_id = ".$_SESSION['user_id']."  group by a.booking_id order by book_date asc, time asc ";
                        ...
                        echo "
                                <li class='booking-list'>
                                    ...
                                    <div class='booking-list-setting'>
                                        <a href = 'user_complain.php?bookid=".$rowBooking['booking_id']."' ><span class='material-symbols-outlined'> info </span> 
                                        </a>
                                    </div>
                                </li>
                                        "; 
